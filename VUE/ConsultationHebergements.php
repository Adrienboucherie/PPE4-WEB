...
$pageConsultationHebergements->contenu = '<section>
          ...
          <table class="table table-striped">
            <thead>	<tr><th>Nom de l\'hébergement</th><th>Adresse</th><th>Ville</th><th>Note</th><th>Commentaire</th></tr></thead><tbody>';
...
foreach ($listeheb as $unHeb){
					...
					<td>'.$unHeb->ville_heb.'</td><td><div class="row"><div class="col-md-1">'.$unHeb->nbetoile.'</div><div class="col-md-1"><img class ="image" id="etoile" src="./Image/etoile.png" alt="Appréciation"></div></div></td><td>'.$unHeb->commentaire.'</td></tr>';
				}
